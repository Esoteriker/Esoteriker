...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Inter&weight=600&size=22&pause=1000&color=2EA44F&center=true&vCenter=true&width=760&lines=AI-native+product+workflows;LLM+systems+%E2%80%A2+agentic+tools+%E2%80%A2+reliable+UX;TypeScript+%2B+Java+%2B+Python+in+production)](https://git.io/typing-svg)
...
![LLM Workflows](https://img.shields.io/badge/LLM_Workflows-111827?style=for-the-badge&logo=openai&logoColor=white)
...
![Async Jobs](https://img.shields.io/badge/Async_Jobs-0F766E?style=for-the-badge)
![Observability](https://img.shields.io/badge/Observability-EA580C?style=for-the-badge)
![WebAssembly](https://img.shields.io/badge/WebAssembly-654FF0?style=for-the-badge&logo=webassembly&logoColor=white)

<br><br>

<img src="https://skillicons.dev/icons?i=ts,react,nextjs,java,spring,python,nodejs,docker,git,github,linux&perline=11" alt="Tech icons" />

</div>

## 🧠 Capability Map

| 🤖 Models | 🛠 Tools | 🧭 Orchestration | 🔍 Reliability | 🎨 Interfaces |
|---|---|---|---|---|
| LLM APIs · RAG | APIs · tool use | async jobs · status | retries · logs | React · Next.js |

## 🧩 Selected Systems

| System | Signal |
|---|---|
| 🌍 [WFP Hunger-Map](https://www.wfp.org/hunger-map) | `Next.js` `data aggregation` `AI explanations` |
| 🔒 EDA Task Orchestration | `private/internal` `async jobs` `secure service integration` |

> [!NOTE]
> EDA source code and detailed product context are not publicly available.

## 💼 Now

**Siemens Digital Industries Software** · TypeScript frontend · Java services · REST APIs · WebAssembly · AI-assisted workflows
