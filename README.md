...
- Designing and maintaining backend APIs for web and mobile clients, with clear service boundaries, request contracts, error behavior, and integration ownership.
- Integrating AI-assisted workflows by connecting external model APIs with internal services for retrieval, explanation, and report-generation scenarios.
...
- About me: [openblog-chi.vercel.app](https://openblog-chi.vercel.app/)
